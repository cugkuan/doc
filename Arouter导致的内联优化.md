...
在 bugly 上收到了一些零星的bug反馈，而且都集中在华为三星手机上;测试包不会出问题，正式包零星出现

```
10-13 10:57:33.264 20813 20813 F hidao.clientap: entrypoint_utils-inl.h:101] Inlined method resolution crossed dex file boundary: from void com.alibaba.android.arouter.routes.ARouter$$Group$$search.loadInto(java.util.Map) in /data/app/~~pobal-FD9Sg3dvd1f1dJJQ==/com.qizhidao.clientapp-i8gnVqTpLmE88LxKmru8Zg==/base.apk/0xb4000077c1d52f10 to void com.alibaba.android.arouter.routes.ARouter$$Group$$search$1.<init>(com.alibaba.android.arouter.routes.ARouter$$Group$$search) in /data/user/0/com.qizhidao.clientapp/files/prodexdir/00O000ll111l_0.dex/0xb4000077b1d78e50. This must be due to duplicate classes or playing wrongly with class loaders. The runtime is in an unsafe state.
2710-13 10:57:33.278 20813 20813 F hidao.clientap: entrypoint_utils-inl.h:101] Inlined method resolution crossed dex file boundary: from void com.alibaba.android.arouter.routes.ARouter$$Group$$search.loadInto(java.util.Map) in /data/app/~~pobal-FD9Sg3dvd1f1dJJQ==/com.qizhidao.clientapp-i8gnVqTpLmE88LxKmru8Zg==/base.apk/0xb4000077c1d52f10 to void com.alibaba.android.arouter.routes.ARouter$$Group$$search$1.<init>(com.alibaba.android.arouter.routes.ARouter$$Group$$search) in /data/user/0/com.qizhidao.clientapp/files/prodexdir/00O000ll111l_0.dex/0xb4000077b1d78e50. This must be due to duplicate classes or playing wrongly with class loaders. The runtime is in an unsafe state.
```
